    ...
    return (
        <div className="flex flex-col min-h-screen bg-gradient-to-r from-blue-500 via-purple-500 to-gray-500 text-white p-6">
            <main className="flex flex-col items-center gap-12 flex-grow">
                ...
                <section className="bg-white/10 backdrop-blur-md p-10 rounded-3xl shadow-2xl border border-white/20 w-full max-w-4xl mx-auto">
                    ...
                    <Slider {...sliderSettings}>
                        <div className="p-4">
                            <Link to="/ambassadors">
                                <div className="relative h-56 w-full rounded-lg overflow-hidden mb-4">
                                    <img src={joueur_lol} alt="Alex" className="absolute inset-0 w-full h-full object-cover"/>
                        ...
                        <div className="p-4">
                            <Link to="/ambassadors">
                                <div className="relative h-56 w-full rounded-lg overflow-hidden mb-4">
                                    <img src={joueur_minecraft} alt="Lucas" className="absolute inset-0 w-full h-full object-cover"/>
                                    <div className="absolute inset-0 bg-black/40 flex flex-col justify-end p-4">
                        ...
                        <div className="p-4">
                            <Link to="/ambassadors">
                                <div className="relative h-56 w-full rounded-lg overflow-hidden mb-4">
                                    <img src={joueuse_rocket_league} alt="Sarah" className="absolute inset-0 w-full h-full object-cover"/>
                                    <div className="absolute inset-0 bg-black/40 flex flex-col justify-end p-4">
                ...
                <section className="bg-white/10 backdrop-blur-md p-10 rounded-3xl shadow-2xl border border-white/20 w-full max-w-4xl">
                    ...
                    <p className="text-lg mb-6">Bienvenue sur Echec&Match, notre site de rencontre dédié aux gamer idéal pour trouver des partenaires de jeu et éviter de jouer seul. Que vous soyez passionné de jeux de tir, de MMORPG, de stratégie ou tout autre genre, notre application de rencontre gamer vous aide à rencontrer des joueurs partageant vos intérêts et votre passion pour le gaming.<br /><br />
                        Echec&Match, vous permet de rencontrer des gamers et gameuses de tous horizons. Grâce à notre système de matchmaking gaming, vous pouvez facilement trouver des partenaires pour jouer en équipe. Que vous cherchiez des coéquipiers pour des parties compétitives ou des amis pour des sessions de jeu décontractées, notre plateforme est conçue pour répondre à vos besoins.<br /><br />
                        En jouant en équipe, vous pouvez améliorer vos compétences, élaborer des stratégies plus efficaces et vivre une expérience de jeu plus enrichissante. Sur notre application de rencontre gamer, Echec&Match, vous pouvez créer un profil détaillé, spécifier vos jeux préférés, votre niveau de compétence et vos disponibilités. Cela permet à notre système de matchmaking gaming de vous mettre en relation avec des joueurs qui correspondent à votre style de jeu et à vos préférences.<br /><br />
                        La diversité de notre communauté est l'un de nos plus grands atouts. Echec&Match, vous offre la possibilité d'élargir votre cercle de connaissances et de créer des souvenirs inoubliables avec d'autres passionnés de jeux vidéo.<br />
                        Notre application offre une expérience utilisateur intuitive et agréable. Avec des fonctionnalités avancées de recherche et de filtrage, trouver des partenaires de jeu n'a jamais été aussi simple. Rejoignez notre communauté aujourd'hui et commencez à profiter de tous les avantages de jouer en équipe.<br /><br />
                        N'attendez plus pour découvrir tous les avantages. Que vous souhaitiez améliorer vos compétences, trouver des amis ou simplement éviter de jouer seul, notre plateforme est là pour vous. Rejoignez-nous dès maintenant et vivez des aventures avec d'autres gamers passionnés grâce à Echec&Match.</p>
                </section>
            </main>
        </div>
    );
