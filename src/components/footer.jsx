  ...
  return (
    <footer className="fixed inset-x-0 bottom-0 w-full bg-[#ffffff20] backdrop-blur-md border-t border-[#ffffff50] text-white py-6 px-4 text-center">
      ...
      <div className="flex justify-center space-x-6">
        <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="text-xl hover:text-yellow-400">
          <FaTiktok />
        </a>
        <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-xl hover:text-yellow-400">
          <FaTwitter />
        </a>
        <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-xl hover:text-yellow-400">
          <FaInstagram />
        </a>
      </div>
